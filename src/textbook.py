...
def start(input_file_contents: str):
    return curses.wrapper(_start, input_file_contents)
...
def _start(stdscr: curses.window, input_file_contents: str):
    container = TextContainer(input_file_contents.split('\n'))
